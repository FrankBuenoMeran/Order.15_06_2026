...
using Orders.Backend2.Repositories.Interfaces;
using Orders.Shared.Response;

namespace Orders.Backend2.Repositories.Implimentations;
...
public class GenericRepository<T> : IGenericRepository<T> where T : class
{
    ...
    public virtual async Task<ActionResponse<T>> AddAsync(T entity)
    {
        ...
        {
            return DbUpdateConcurrencyExceptionActionResponse();
        }
    ...
    private ActionResponse<T> DbUpdateConcurrencyExceptionActionResponse()
    {
        return new ActionResponse<T>
        {
